...
@Component({
  selector: 'app-navbar-directors',
  templateUrl: './navbar-directors.component.html',
  styleUrls: ['./navbar-directors.component.css']
})
export class NavbarDirectorsComponent implements OnInit {
