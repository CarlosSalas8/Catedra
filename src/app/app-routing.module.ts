...
const routes: Routes = [
  ...
  { path: 'home-docente/:email', loadChildren: () => import('./components/docente/home-docente/home-docente.module').then(x => x.HomeDocenteModule),canActivate: [AuthGuard, RoleGuard], data: { expectedRole: ['teacher', 'admin'] }, },
  { path: 'seguimiento-docente/:email', loadChildren: () => import('./components/docente/seguimiento-docente/seguimiento-docente.module').then(x => x.SeguimientoDocenteModule),canActivate: [AuthGuard, RoleGuard], data: { expectedRole: ['teacher', 'admin']  } },
  { path: 'actividades-docentes/:id/:assistant/:email', loadChildren: () => import('./components/docente/actividades-docentes/actividades-docentes.module').then(m => m.ActividadesDocentesModule),canActivate: [AuthGuard, RoleGuard], data: { expectedRole: ['teacher', 'admin']  } },
