...
const routes: Routes = [
  ...
  { path: 'home-docente', loadChildren: () => import('./components/docente/home-docente/home-docente.module').then(x => x.HomeDocenteModule),canActivate: [AuthGuard, RoleGuard], data: { expectedRole: 'teacher' } },
  { path: 'seguimiento-docente', loadChildren: () => import('./components/docente/seguimiento-docente/seguimiento-docente.module').then(x => x.SeguimientoDocenteModule),canActivate: [AuthGuard, RoleGuard], data: { expectedRole: 'teacher' } },
  { path: 'presentacion-docente', loadChildren: () => import('./components/docente/presentacion-docente/presentacion-docente.module').then(x => x.PresentacionDocenteModule),canActivate: [AuthGuard, RoleGuard], data: { expectedRole: 'teacher' } },
  { path: 'actividades-docentes/:id', loadChildren: () => import('./components/docente/actividades-docentes/actividades-docentes.module').then(m => m.ActividadesDocentesModule),canActivate: [AuthGuard, RoleGuard], data: { expectedRole: 'teacher' } },
